<template>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
      ...
      <div :style="`font-size:${fontSize}px;font-weight:${fontWeight}`" :class="`flex h-[65vh] text-center mx-4`">
        <div class="m-auto">
      ...
      <div class="flex justify-center text-center my-4">
        <p class="text-3xl font-extrabold">{{ zikerCount }} / {{ steps[currentStep].zikerCount }}</p>
      </div>
      <div class="flex justify-center">
        <ion-button size="large" @click="nextStep">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
const steps = [
  ...
  {
    title: "Ziker 5",
    content: "اللّهُـمَّ ما أَصْبَـَحَ بي مِـنْ نِعْـمَةٍ أَو بِأَحَـدٍ مِـنْ خَلْـقِك ، فَمِـنْكَ وَحْـدَكَ لا شريكَ لَـك ، فَلَـكَ الْحَمْـدُ وَلَـكَ الشُّكْـر. ",
    zikerCount:1
  },
  {
    title: "Ziker 6",
